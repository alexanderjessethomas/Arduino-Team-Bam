...
void setup() {
  ...
  //Setting pins for joystick and buttons to input_pullup since there is no power going to pins.
  ...
  pinMode(atariButtonPin, INPUT_PULLUP);
...
void loop() {
  ...
  int buttonPinState = digitalRead(atariButtonPin);
  ...
  if (bluetoothState == 0 && parentalControl == true) {
    ...
    //}
      ...
      }else if(buttonPinState == 0){
        Serial.println("Atari Button was pressed");
